...
Block::Block(Game* game, const std::string &texturePath, int x, int y)
        :Actor(game)
{
    new DrawSpriteComponent(this, "../Assets/Sprites/"+texturePath+".png", x, y, 115);

    if(texturePath == "Temple/DoorFire")
    {
        mDrawComponent = new DrawAnimatedComponent(this, "../Assets/Sprites/Temple/TempleAssets.png", "../Assets/Sprites/Temple/TempleAssets.json", 1/1.5f, 110);
