        ...
        , mWinnerTime(0)
{
    ...
    if (mType == PlayerType::FireBoyHead)
    {
        ...
        mDrawComponent->AddAnimation("RunningF", std::vector<int>{75,76,77,78,79,80,81,82,83,84,85});
    ...
    else if (mType == PlayerType::WaterGirlHead)
    {
        ...
        mDrawComponent->AddAnimation("RunningW", std::vector<int>{175,176,177,178,179,180,181,182,183,184,185});
...
void Player::ManageAnimations()
{
    ...
    {
        if(PlayerType::FireBoyHead == mType)
            mDrawComponent->SetAnimation("RunningF");
        if(PlayerType::WaterGirlHead == mType)
            mDrawComponent->SetAnimation("RunningW");
    }
}
